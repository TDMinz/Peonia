...
export default function StaffWorkshopsPage() {
  ...
  return (
    <StaffLayout title="Quản lý workshop" subtitle="Tạo, sửa, xoá workshop và upload ảnh">
        ...
        <form onSubmit={handleSubmit} className="rounded-[2rem] border border-[#e8edf3] bg-white p-6 shadow-[0_10px_25px_rgba(15,23,42,0.04)]">
          ...
          <div className="space-y-4">
            ...
            <label className="block">
              ...
              <label className="flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-[#d8e1ea] bg-[#f6f7fb] px-5 py-8 text-center transition hover:border-[#111827]">
          ...
          <button disabled={saving} className="mt-6 flex w-full items-center justify-center gap-2 rounded-full bg-[#111827] px-5 py-4 text-sm font-medium text-white transition hover:bg-black disabled:opacity-60">
